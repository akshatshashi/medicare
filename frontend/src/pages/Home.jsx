          ...
          <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
            ...
            <div>
              <div className=" lg:w-[570px]">
                ...
                <a href="http://localhost:3000/doctors">Request an Appointment</a>
                </button>

                <button className="btn" style={{ marginRight: '10px' }}>
                <a href="https://yourdost.com/">Your Dost</a>
                </button>

                <button className="btn" style={{ marginRight: '10px' }}>
                <a href="https://medulance.com/action/signin">Book Ambulance</a>
                </button>
              </div>
            ...
            {/* =========== hero img ============ */}
            <div className="flex gap-[30px] justify-end rounded-br-[]">
              <div>
                <img className="w-full" src={doctor1} alt="hero_img" />
              </div>
              <div className="mt-[30px]">
                <img
                  ...
                  alt="hero_img"
                />
                <img className="w-full" src={doctor3} alt="hero_img" />
        ...
        <div className="container">
          <div className="flex justify-between items-center flex-col lg:flex-row">
            ...
            <div className="relative z-10  xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
              <img src={doctor4} className="w-3/4" alt="about_img" />
        ...
        <div className="container">
          <div className="flex justify-between gap-[50px] lg:gap-0">
            <div className="w-1/2 hidden md:block">
              <img className="ml-[-10px]" src={doctor2} alt="" />
            </div>
